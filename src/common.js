export default function (Vue, options) {
  Vue.prototype.$$ = {
    ...
    msgAlert: function (content = '', title = '', showcb = null, hidecb = null) {
      Vue.$vux.alert.show({
        title: title,
        content: content,
        onShow() {
    ...
    msgConfirm: function (content = '提示', title = '提示', confirmcb = null, cancelcb = null, showcb = null, hidecb = null) {
